...
public class Account extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(toolbar);       getSupportActionBar().setDisplayHomeAsUpEnabled(false);
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.content_frame, new Account_Fragment()).commit();
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
...

                {
                    ...
                    if(asd.length() == 0 )              {
                        ...
                        Intent intent = new Intent(getBaseContext(), Account.class);                  startActivity(intent);               }             else             {                   Intent intent = new Intent(getBaseContext(), Dashboard_Fragment.class);                  startActivity(intent);              } Intent intent = new Intent(getBaseContext(), Account.class);
