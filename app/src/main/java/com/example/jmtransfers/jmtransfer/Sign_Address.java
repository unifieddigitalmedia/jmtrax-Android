package com.example.jmtransfers.jmtransfer;
...
public class Sign_Address extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment sign_address = new Sign_up_address();


        Bundle args = new Bundle();


        args.putString("sendersID",getIntent().getStringExtra("sendersID"));


        sign_address.setArguments(args);


        getSupportFragmentManager().beginTransaction().add(R.id.content_frame,sign_address ).commit();
