...
public class RegisterTabActivity extends AppCompatActivity {
    ...
    private NestedScrollView nestedScroll;      SharedPreferences.Editor editor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.content_frame, new Sign_up_details()).commit();
    ...
    private class OnTabSelectedListener implements TabLayout.OnTabSelectedListener {
        ...
        public void onTabSelected(TabLayout.Tab tab) {
...

            {
                ...
                getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, new Sign_up_details()).commit();
...

            {
                ...
                getSupportFragmentManager().beginTransaction().replace(R.id.content_frame, new Sign_up_address()).commit();
    ...
    public void signupUser(String t) {
       ...
       switch (tabLayout.getSelectedTabPosition()) {
            ...
            case 0:
                ...
                Intent intent = new Intent(getBaseContext(), Sign_Address.class);

                intent.putExtra("sendersID",t);

                startActivity(intent);

               /* tabLayout.getTabAt(1).setTag(t);
