...
import android.support.v7.app.ActionBar; import android.widget.TextView;
...
public class Transfer_Receipt_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab.setOnClickListener(new View.OnClickListener() {
            ...
            settings =  getSharedPreferences(PREFS_NAME, MODE_PRIVATE);
                ...
                editor = settings.edit();                  editor.putString("Username", "");
        ...
        String args = intent.getStringExtra(Beneficary_List_Fragment.EXTRA_DATA);

        Transfer_Receipt_Fragment payFragment = new Transfer_Receipt_Fragment();
    ...
    private class OnTabSelectedListener implements TabLayout.OnTabSelectedListener {
        ...
        public void onTabSelected(TabLayout.Tab tab) {
...

            {
                ...
                editor = settings.edit();               String asd = settings.getString("Username", "");
