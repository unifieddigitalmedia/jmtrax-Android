...
public class Confirm_Sender extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab.setOnClickListener(new View.OnClickListener() {
            ...
            @Override             public void onClick(View v) {
                ...
                Intent intent = new Intent(getBaseContext(),Dashboard.class);                   startActivity(intent);                }         });
        ...
        Confirm_Sender_Fragment payFragment = new Confirm_Sender_Fragment();
