...
public class Beneficary_List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tab.setOnClickListener(new View.OnClickListener() {
            ...
            @Override             public void onClick(View v) {
                ...
                editor = settings.edit();                  editor.putString("Username", "");   editor.commit();


                editor.commit();                    Intent intent = new Intent(getBaseContext(),Dashboard.class);
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.content_frame, new Beneficary_List_Fragment()).commit();
