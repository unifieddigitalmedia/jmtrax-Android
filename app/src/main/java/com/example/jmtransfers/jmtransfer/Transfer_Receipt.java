...
public class Transfer_Receipt extends AppCompatActivity {

    private NestedScrollView nestedScroll;      SharedPreferences.Editor editor;      SharedPreferences settings;
